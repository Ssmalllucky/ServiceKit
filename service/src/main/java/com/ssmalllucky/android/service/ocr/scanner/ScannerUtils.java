...
import com.ssmalllucky.android.service.ocr.idcard.IdCardUtils;
...
//    }
     ...
     * @return
     */
    public static com.ssmalllucky.android.service.ocr.scanner.Result decodeIdCard(Context context, Bitmap bmp) throws Exception {
        if (bmp == null) return null;
